...
export PCT_OPTIONS="
  ...
  $PW
"
bash -c "$(wget -qLO - https://raw.githubusercontent.com/Beef-Tech/Pimox-utils/feat/moveToarm64/ct/create_lxc.sh)" || exit
msg_info "Starting LXC Container"
pct start $CTID
msg_ok "Started LXC Container"
lxc-attach -n $CTID -- bash -c "$(wget -qLO - https://raw.githubusercontent.com/Beef-Tech/Pimox-utils/feat/moveToarm64/install/nginx-proxy-manager-install.sh)" || exit
